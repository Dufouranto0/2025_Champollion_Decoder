...
def main():
    ...
    parser.add_argument('-p', '--path', nargs='+', type=str, help="Base folder path to the reconstructions.")
    ...
    if not args.path:
        print(f"No files found matching the pattern '{args.path}'. Please check your paths.")
        return
